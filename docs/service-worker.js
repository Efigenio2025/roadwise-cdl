const CACHE='roadwise-cdl-v7';
const ASSETS=['./','./index.html','./site.css','./site.css?v=7','./practice.js','./practice.js?v=7','./selector.js','./questions.json','./manifest.webmanifest','./og.png'];
