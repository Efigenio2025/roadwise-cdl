const CACHE='roadwise-cdl-v6';
const ASSETS=['./','./index.html','./site.css','./site.css?v=6','./practice.js','./practice.js?v=6','./selector.js','./questions.json','./manifest.webmanifest','./og.png'];
